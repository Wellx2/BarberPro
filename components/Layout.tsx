...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // UX Decision: Access subscriptionEnabled correctly from settings object
  // Fix: Accessing settings.subscriptionEnabled directly as defined in Shop interface
  const showPlans = shop.settings.subscriptionEnabled;
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              {isAuthenticated ? (
                <div className="flex items-center gap-4">
                  <Link to="/dashboard" className="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-xl font-bold transition-all">
                    Dashboard
                  </Link>
