    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
        ...
        <div className="prose prose-amber max-w-none text-gray-600 space-y-6">
          ...
          <p>
            Garantimos a não comercialização ou aluguel de seus dados. O compartilhamento ocorre apenas com prestadores de serviços de infraestrutura (provedores de nuvem, envios automáticos de e-mail) estritamente essenciais à operação do negócio, sob contratos de confidencialidade vinculativos. A Plataforma BarberPro atua como processadora tecnológica das informações.
          </p>

          <h3 className="text-xl font-bold text-gray-900">5. Seus Direitos (LGPD)</h3>
          <p>
            Você possui o direito garantido por lei de confirmar a existência de tratamento, acessar seus dados, solicitar correção de informações incompletas, anonimização, ou a exclusão de seus dados pessoais, salvo quando houver base legal para a retenção (como obrigações fiscais ou prevenção de fraudes).
          </p>
          <p>
            Para exercer esses direitos, ou esclarecer dúvidas sobre esta Política, entre em contato através dos canais de atendimento oficiais da nossa barbearia.
          </p>
        </div>
      </div>
    </div>
