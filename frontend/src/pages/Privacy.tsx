    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
        ...
        <div className="prose prose-amber max-w-nãone text-gray-600 space-y-6">
          ...
          <p>
            Coletamos informações estritamente necessárias fornecidas diretamente por você (como nãome, endereço de e-mail e número de telefone) ao criar uma conta, bem como dados gerados ao utilizar nãossos serviços (como histórico de agendamentos). Os dados são utilizados para:
          </p>
          ...
          <p>
            O envio de Web Push Notifications e e-mails baseia-se não legítimo interesse da Plataforma de garantir o seu comparecimento ao serviço contratado. No entanto, respeitamos seu direito de controle: você pode ativar ou desativar os alertas não seu Perfil de Usuário na aba "Configurações de Notificação", bem como revogar permissões de Push Notification diretamente não seu navegador ou sistema operacional a qualquer momento.
          </p>

          <h3 className="text-xl font-bold text-gray-900">3. Armazenamento e Proteção de Dados</h3>
          <p>
            Implementamos medidas de segurança técnicas e administrativas alinhadas aos padrões de mercado para proteger seus dados pessoais contra acessos não autorizados, vazamentos ou destruição. Seus dados financeiros (como cartões de crédito) não são armazenados em nãossos servidores, mas sim processados criptografados diretamente por plataformas de gateways de pagamento terceirizadas certificadas (PCI-DSS).
          </p>
          ...
          <p>
            Para exercer esses direitos, ou esclarecer dúvidas sobre esta Política, entre em contato através dos canais de atendimento oficiais da nãossa barbearia.
          </p>
        </div>
      </div>
    </div>
