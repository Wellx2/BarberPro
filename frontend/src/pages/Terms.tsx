    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12">
        ...
        <div className="prose prose-amber max-w-nãone text-gray-600 space-y-6">
          ...
          <p>
            Os agendamentos realizados através da nossa Plataforma são compromissos firmados entre o cliente e o profissional. Solicitações de cancelamentos ou remarcações devem ser feitas com pelo menos 2 horas de antecedência. Cancelamentos tardios ou o não comparecimento ("no-show") podem resultar na cobrança de taxas compensatórias, perda de benefícios de fidelidade ou até bloqueio temporário de agendamentos futuros.
          </p>
